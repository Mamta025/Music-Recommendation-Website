...
$sql = "SELECT sname ,country ,link FROM song,singer,sungby WHERE song.sid=sungby.sid and singer.singer_id=sungby.singer_id and country like '%$str%' ";
...
for ($i = 0; $i < count($datas); $i++){
  echo "<tr><td>".$datas[$i]["sname"]."</td><td>".$datas[$i]["country"]."</td><td>".$datas[$i]["link"]."</td></tr>";
