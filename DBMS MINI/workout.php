...
<body>
   <?php
   $sql = "SELECT sname , name , company , year_of_release , link FROM song,singer,producer,sungby,producedby WHERE mid=3 and lang='English' and song.sid=sungby.sid and singer.singer_id=sungby.singer_id and producer.pid=producedby.pid and song.sid=producedby.sid order by rand() limit 6 ";
