...
<body>
   <?php
   $sql = "SELECT sname , name , company , year_of_release , link FROM song,singer,producer,sungby,producedby WHERE lang='English' and song.sid=sungby.sid and singer.singer_id=sungby.singer_id and producer.pid=producedby.pid and song.sid=producedby.sid order by rand() limit 6 ";
...
<p>
    	<h1 style="color:#DAF7A6 ;font-family: 'Great Vibes', cursive; text-align: center;font-size: 3em; font-stretch: ultra-expanded; letter-spacing: 5px ; "> Trending </h1>
</p>
	<div class="container">
		<div class="box">
			<div class="imgBox">
				<img src="trendingimages/1-.jpg">
			</div>
			<div class="details">
				<div class="content">
