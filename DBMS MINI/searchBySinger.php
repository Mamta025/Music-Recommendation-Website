...
$sql = "SELECT sname , name ,link FROM song,singer,sungby WHERE song.sid=sungby.sid and singer.singer_id=sungby.singer_id and name like '%$str%' ";
...
for ($i = 0; $i < count($datas); $i++){
  echo "<tr><td>".$datas[$i]["sname"]."</td><td>".$datas[$i]["name"]."</td><td>".$datas[$i]["link"]."</td></tr>";
