...
$sql = "SELECT sname , company ,link FROM song,producer,producedby WHERE producer.pid=producedby.pid and song.sid=producedby.sid and company like '%$str%' ";
...
if (mysqli_num_rows($result) > 0) {
  ...
  echo '<div class="my_class">'.$msg.'</div>';
}
for ($i = 0; $i < count($datas); $i++){
  echo "<tr><td>".$datas[$i]["sname"]."</td><td>".$datas[$i]["company"]."</td><td>".$datas[$i]["link"]."</td></tr>";
